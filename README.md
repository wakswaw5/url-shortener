...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/url-shortener#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/url-shortener
```

A live public deployment of this template is available at [https://url-shortener.templates.workers.dev](https://url-shortener.templates.workers.dev)
